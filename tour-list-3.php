        ...
        <div class="breadcrumbs">
            <div class="wrap">
                <div class="wrap_float">
                    ...
                    <a href="#" class="current">Tour Classic 2 Columns</a>
                </div>
            </div>
        </div>
                ...
                <div class="wrap_float">
                    ...
                    <div class="main">
                        <div class="most_popular__section">
                            <a href="single.php" class="slider_item" style="background-image: url(img/prevput7.jpg)">
                            ...
                            <a href="single.php" class="slider_item" style="background-image: url(img/prevput8.jpg)">
                            ...
                            <a href="single.php" class="slider_item" style="background-image: url(img/prevput9.jpg)">
                                <div class="slider_item__content">
                                    <div class="rating">
                                        <div class="stars">
                                            <div class="star active"></div>
                            ...
                            <a href="single.php" class="slider_item" style="background-image: url(img/prevput10.jpg)">
                                <div class="slider_item__content">
                                    <div class="rating">
                                        <div class="stars">
                                            <div class="star active"></div>
                            ...
                            <a href="single.php" class="slider_item" style="background-image: url(img/prevput11.jpg)">
                                <div class="slider_item__content">
                                    <div class="rating">
                                        <div class="stars">
                                            <div class="star active"></div>
                            ...
                            <a href="single.php" class="slider_item" style="background-image: url(img/prevput13.jpg)">
                                <div class="slider_item__content">
                                    <div class="rating">
                                        <div class="stars">
                                            <div class="star active"></div>
                                    ...
                                    <div class="title">
                                        New York, United States | from $1900
                                    </div>
                                    <div class="description">
                                        6 excursions to the main cities of the country, admire the beautiful autumn gardens
                                    </div>
                            ...
                            <a href="single.php" class="slider_item" style="background-image: url(img/prevput14.jpg)">
                                <div class="slider_item__content">
                                    <div class="rating">
                                        <div class="stars">
                                            <div class="star active"></div>
