...
window.onclick = function(event) {
    if (event.target == modal) {
        ...
        <div class="breadcrumbs">
            <div class="wrap">
                <div class="wrap_float">
                    ...
                    <a href="#" class="current">Tour Classic 3 Columns</a>
                </div>
            </div>
        </div>
        ...
        <div class="page_content three-columns">
            <div class="wrap">
                <div class="wrap_float">
                    <div class="section-title">Tour Classic 3 Columns</div>
                    <div class="main">
                        <div class="most_popular__section">
                            <a class="slider_item" style="background-image: url(img/prevput7.jpg)">
                            ...
                            <a class="slider_item" style="background-image: url(img/prevput8.jpg)">
                            ...
                            <a class="slider_item" style="background-image: url(img/prevput9.jpg)">
                                <div class="slider_item__content">
                                    <div class="rating">
                                        <div class="stars">
                                            <div class="star active"></div>
                            ...
                            <a class="slider_item" style="background-image: url(img/prevput10.jpg)">
                                <div class="slider_item__content">
                                    <div class="rating">
                                        <div class="stars">
                                            <div class="star active"></div>
                            ...
                            <a class="slider_item" style="background-image: url(img/prevput11.jpg)">
                                <div class="slider_item__content">
                                    <div class="rating">
                                        <div class="stars">
                                            <div class="star active"></div>
                            ...
                            <a class="slider_item" style="background-image: url(img/prevput12.jpg)">
                                <div class="slider_item__content">
                                    <div class="rating">
                                        <div class="stars">
                                            <div class="star active"></div>
                ...
                <div class="wrap">
                    <div class="wrap_float">
                        ...
                        <div class="footer_center_right">
                            ...
                            <div class="text">
                                <p>Head Office: <b>914, Wave Silver Tower, Sector-18, Noida.</b> </p>
