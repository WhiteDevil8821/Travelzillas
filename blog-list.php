        ...
        <div class="breadcrumbs">
            <div class="wrap">
                <div class="wrap_float">
                    ...
                    <a href="#" class="current">Blog Full Right Sidebar</a>
                </div>
            </div>
        </div>
        ...
        <div class="page_content blog-page">
            <div class="wrap">
                <div class="wrap_float">
                    ...
                    <div class="main">
                        <div class="blog-list">
                            <a href="blog-single.php" class="blog-item">
                                <div class="_img" style="background-image: url(img/prevnap2.jpg)">
                                    <div class="sq_parent">
                                        <div class="sq_wrap">
                            ...
                            <a href="blog-single.php" class="blog-item">
                                <div class="_img" style="background-image: url(img/prevnap3.jpg)">
                                    <div class="sq_parent">
                                        <div class="sq_wrap">
                                            <div class="sq_content"></div>
                                        </div>
                    ...
                    <div class="sidebar">
                        ...
                        <div class="text_widget" style="background-color: #009A70;">
                            <div class="_title">
                                Text Widget
                            </div>
                            <div class="_text">
