        ...
        <div class="breadcrumbs">
            <div class="wrap">
                <div class="wrap_float">
                    ...
                    <a href="#" class="current">Blogs</a>
                </div>
            </div>
        </div>
        <div class="image_bg--single" style="background-image: url(img/header5.jpg);"></div>
                ...
                <div class="wrap_float">
                    ...
                    <div class="main">
                        <div class="blog-list two-colums">
                            <a href="blog-andaman-1.php" class="blog-item">
                                <div class="_img" style="background-image: url(img/andamanblog1.jpg)">
                                    <div class="sq_parent">
                                        <div class="sq_wrap">
                                ...
                                <div class="_date">FEBRUARY 26/2021 | FRIENDS & FAMILY</div>
                                <div class="_title">
                            ...
                            <a href="blog-kerala-1.php" class="blog-item">
                                <div class="_img" style="background-image: url(img/keralablog1.jpg)">
                                    <div class="sq_parent">
                                        <div class="sq_wrap">
                                            <div class="sq_content"></div>
                                        </div>
                                ...
                                <div class="_date">FEBRUARY 26/2021 | HONEYMOON</div>
                                <div class="_title">
                            ...
                            <a href="blog-sikkim-1.php" class="blog-item">
                                <div class="_img" style="background-image: url(img/sikkimblog1.jpg)">
                                    <div class="sq_parent">
                                        <div class="sq_wrap">
                                            <div class="sq_content"></div>
                                        </div>
                                ...
                                <div class="_date">FEBRUARY 26/2021 | FAMILY</div>
                                <div class="_title">
                            ...
                            <a href="blog-andaman-2.php" class="blog-item">
                                <div class="_img" style="background-image: url(img/andamanblog2.jpg)">
                                    <div class="sq_parent">
                                        <div class="sq_wrap">
                                            <div class="sq_content"></div>
                                        </div>
                            ...
                            <a href="blog-srilanka-1.php" class="blog-item">
                                <div class="_img" style="background-image: url(img/srilankablog1.jpg)">
                                    <div class="sq_parent">
                                        <div class="sq_wrap">
                                            <div class="sq_content"></div>
                                        </div>
                            ...
                            <a href="blog-maldives-1.php" class="blog-item">
                                <div class="_img" style="background-image: url(img/maldivesblog1.jpg)">
                                    <div class="sq_parent">
                                        <div class="sq_wrap">
                                            <div class="sq_content"></div>
                                        </div>
                            ...
                            <a href="blog-kerala-2.php" class="blog-item">
                                <div class="_img" style="background-image: url(img/keralablog2.jpg)">
                                    <div class="sq_parent">
                                        <div class="sq_wrap">
                                            <div class="sq_content"></div>
                                        </div>
                                ...
                                <div class="_date">FEBRUARY 26/2021 | FRIENDS</div>
                                <div class="_title">
                            ...
                            <a href="blog-sikkim-2.php" class="blog-item">
                                <div class="_img" style="background-image: url(img/sikkimblog2.jpg)">
                                    <div class="sq_parent">
                                        <div class="sq_wrap">
                                            <div class="sq_content"></div>
                                        </div>
                        ...
                        <div class="pagination">
                            <ul>
                                ...
                                <li><a href="blog-list-2-2.php">2</a></li>
                                <li><a href="#">3</a></li>
                                <li><a href="#">4</a></li>
                                <li class="next"><a href="blog-list-2-2.php"></a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="sidebar">
                            ...
                            <ul>
                                <li>
                                    <a href="#">
                                        ...
                                        <span class="_title">Article</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <span class="count">12</span>
                                        <span class="_title">Building</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <span class="count">673</span>
                                        <span class="_title">Constructions</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
