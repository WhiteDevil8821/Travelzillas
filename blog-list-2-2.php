                            ...
                            <div class="scroll">
                                ...
                                <div class="scroll_wrap">
                                    <ul>
                                        ...
                                        <li class="dropdown_li">
                                            <a href="blog-list-2.php" class="active">
                                                <span>Blog</span>
                                            </a>
                                            <div class="dropdown-menu">
                                                <ul>
        ...
        <div class="breadcrumbs">
            <div class="wrap">
                <div class="wrap_float">
                    ...
                    <a href="#" class="current">Blogs Page 2</a>
                </div>
            </div>
        </div>
                ...
                <div class="wrap_float">
                    ...
                    <div class="main">
                        <div class="blog-list two-colums">
                            <a href="blog-srilanka-2.php" class="blog-item">
                                <div class="_img" style="background-image: url(img/srilankablog2.jpg)">
                                    <div class="sq_parent">
                                        <div class="sq_wrap">
                            ...
                            <a href="blog-maldives-2.php" class="blog-item">
                                <div class="_img" style="background-image: url(img/maldivesblog2.jpg)">
                                    <div class="sq_parent">
                                        <div class="sq_wrap">
                                            <div class="sq_content"></div>
                                        </div>
                            ...
                            <a href="#" class="blog-item">
                                <div class="_img" style="background-image: url(img/prevnap4.jpg)">
                                    <div class="sq_parent">
                                        <div class="sq_wrap">
                                            <div class="sq_content"></div>
                                        </div>
                                ...
                                <div class="_date">JUNE 6/2019 | UNCATEGORIZED</div>
                                <div class="_title">
                            ...
                            <a href="#" class="blog-item">
                                <div class="_img" style="background-image: url(img/prevnap5.jpg)">
                                    <div class="sq_parent">
                                        <div class="sq_wrap">
                                            <div class="sq_content"></div>
                                        </div>
                            ...
                            <a href="#" class="blog-item">
                                <div class="_img" style="background-image: url(img/prevnap6.jpg)">
                                    <div class="sq_parent">
                                        <div class="sq_wrap">
                                            <div class="sq_content"></div>
                                        </div>
                            ...
                            <a href="#" class="blog-item">
                                <div class="_img" style="background-image: url(img/prevnap7.jpg)">
                                    <div class="sq_parent">
                                        <div class="sq_wrap">
                                            <div class="sq_content"></div>
                                        </div>
                            ...
                            <a href="#" class="blog-item">
                                <div class="_img" style="background-image: url(img/prevnap8.jpg)">
                                    <div class="sq_parent">
                                        <div class="sq_wrap">
                                            <div class="sq_content"></div>
                                        </div>
                            ...
                            <a href="#" class="blog-item">
                                <div class="_img" style="background-image: url(img/prevnap9.jpg)">
                                    <div class="sq_parent">
                                        <div class="sq_wrap">
                                            <div class="sq_content"></div>
                                        </div>
                        ...
                        <div class="pagination">
                            <ul>
                                <li class="prev"><a href="blog-list-2.php"></a></li>
                                <li><a href="blog-list-2.php">1</a></li>
