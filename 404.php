...
<head>
    <meta charset="UTF-8">
    <title>404 page | Travelzillas</title>
...
<body>
    <div class="container">
        <div class="page_404" style="background-image: url(img/404.jpg);">
            <div class="wrap">
                <div class="wrap_float">
                    <a href="/" class="logo"><img src="img/logo_w.png" height="40px" width="200px"></a>
                    <div class="center-text">
                        <div class="title">404 page not found</div>
                        <div class="subtitle">Sorry, we couldn’t find the page you’re looking for.</div>
